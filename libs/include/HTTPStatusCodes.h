...
char HttpStatus_isRedirection(int code)  ; /*!< \returns \c true if the given \p code is a redirectional code. */
char HttpStatus_isClientError(int code)  ; /*!< \returns \c true if the given \p code is a client error code. */
char HttpStatus_isServerError(int code)  ; /*!< \returns \c true if the given \p code is a server error code. */
char HttpStatus_isError(int code)        ; /*!< \returns \c true if the given \p code is any type of error code. */
