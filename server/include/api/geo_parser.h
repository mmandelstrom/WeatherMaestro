...
#define CITY_COORD_BUFFER_LENGTH                                               \
  12 // How many max chars we take from latitude+longitude param strings. 12
     // will for example allow -111.111111
#define CITY_NAME_BUFFER_LENGTH                                                \
  128 // How many max chars we take from name param string
...
/** Heap init for multi Geos wrapper struct. Count decides how many Geo structs
 * to init To init their weather/forecast structs, pass true as that arg */
