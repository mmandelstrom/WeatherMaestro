...
#define NOMINATIM_GEOCODE_QUERY                                                \
  "https://nominatim.openstreetmap.org/"                                       \
  "search?format=json&addressdetails=1&q=%s"
...
int nominatim_get_geo_by_query(Nominatim_Geo **_NOM_Geo_Ptr, int *_geo_count,
                               const char *_query);
// int nominatim_get_geo_by_coords(Nominatim_Geo* _NOM_Geo, int* _geo_count,
